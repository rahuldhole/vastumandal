...
(0, vitest_1.describe)("dxf-exporter tests", () => {
    ...
    (0, vitest_1.it)("should generate a valid CAD command script for a beam section", () => {
        const scriptString = (0, index_1.exportBeamSectionToScript)({
            elementId: "B1",
            width: 300,
            depth: 600,
            bottomBarCount: 3,
        ...
        // Write to tmp dir for manual inspection
        const filePath = path_1.default.join(tmpDir, "test-beam-output.scr");
        fs_1.default.writeFileSync(filePath, scriptString);
        // Assert that the script contains valid AutoCAD commands
        (0, vitest_1.expect)(scriptString).toContain("_-LAYER M CONCRETE C 7");
        (0, vitest_1.expect)(scriptString).toContain("_-LAYER M REBAR C 1");
        (0, vitest_1.expect)(scriptString).toContain("_LINE");
        (0, vitest_1.expect)(scriptString).toContain("_CIRCLE");
        (0, vitest_1.expect)(scriptString).toContain("_ZOOM E");
    });
    ...
    (0, vitest_1.it)("should generate a valid CAD command script for a column section", () => {
        const scriptString = (0, index_1.exportColumnSectionToScript)({
            columnId: "C1",
            level: "Ground",
            concreteGrade: "M25",
            width: 400,
        ...
        const filePath = path_1.default.join(tmpDir, "test-column-output.scr");
        fs_1.default.writeFileSync(filePath, scriptString);
        (0, vitest_1.expect)(scriptString).toContain("_-LAYER M CONCRETE C 7");
        (0, vitest_1.expect)(scriptString).toContain("_LINE");
        (0, vitest_1.expect)(scriptString).toContain("_ZOOM E");
    });
    (0, vitest_1.it)("should generate a valid CAD command script for a slab section", () => {
        const scriptString = (0, index_1.exportSlabSectionToScript)({
            slabId: "S1",
            lx: 4000,
            ly: 5000,
            depth: 150,
        ...
        const filePath = path_1.default.join(tmpDir, "test-slab-output.scr");
        fs_1.default.writeFileSync(filePath, scriptString);
        (0, vitest_1.expect)(scriptString).toContain("_-LAYER M CONCRETE C 7");
        (0, vitest_1.expect)(scriptString).toContain("_LINE");
        (0, vitest_1.expect)(scriptString).toContain("_ZOOM E");
    });
    (0, vitest_1.it)("should generate a valid CAD command script for a foundation section", () => {
        const scriptString = (0, index_1.exportFoundationSectionToScript)({
            footingId: "F1",
            lx: 2000,
            ly: 2000,
            depth: 400,
        ...
        const filePath = path_1.default.join(tmpDir, "test-foundation-output.scr");
        fs_1.default.writeFileSync(filePath, scriptString);
        (0, vitest_1.expect)(scriptString).toContain("_-LAYER M CONCRETE C 7");
        (0, vitest_1.expect)(scriptString).toContain("_LINE");
        (0, vitest_1.expect)(scriptString).toContain("_ZOOM E");
    });
    (0, vitest_1.it)("should generate a valid CAD command script for a tank section", () => {
        const scriptString = (0, index_1.exportTankSectionToScript)({
            tankId: "T1",
            type: "UNDERGROUND",
            capacity: 30000,
            width: 3000,
        ...
        const filePath = path_1.default.join(tmpDir, "test-tank-output.scr");
        fs_1.default.writeFileSync(filePath, scriptString);
        (0, vitest_1.expect)(scriptString).toContain("_-LAYER M CONCRETE C 7");
        (0, vitest_1.expect)(scriptString).toContain("_LINE");
        (0, vitest_1.expect)(scriptString).toContain("_ZOOM E");
    });
    (0, vitest_1.it)("should generate a valid CAD command script for a stairs section", () => {
        const scriptString = (0, index_1.exportStairsSectionToScript)({
            stairId: "ST1",
            tread: 250,
            rise: 150,
            numberOfSteps: 10,
        ...
        const filePath = path_1.default.join(tmpDir, "test-stairs-output.scr");
        fs_1.default.writeFileSync(filePath, scriptString);
        (0, vitest_1.expect)(scriptString).toContain("_-LAYER M CONCRETE C 7");
        (0, vitest_1.expect)(scriptString).toContain("_LINE");
        (0, vitest_1.expect)(scriptString).toContain("_ZOOM E");
